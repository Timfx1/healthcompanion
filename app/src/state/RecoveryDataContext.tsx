  ...
  const addPhoto = useCallback(
    (uri: string, caption: string) => {
      ...
      pushEntry({
        ...
        type: "photo",
        date: photo.date,
        // The CAPTION is optional, so the title falls back to something neutral
        // rather than to the uri. A file path on the timeline would be the app
        // showing its plumbing to somebody who photographed a surgical wound.
