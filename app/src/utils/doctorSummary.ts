...
export function buildDoctorSummary(input: DoctorSummaryInput, now = new Date()): string {
  ...
  lines.push("—");
  lines.push("This is a self-reported summary from the Recovery Health Companion app. It is not a medical assessment,");
  lines.push("and Recovery Health Companion is not a medical device. It does not diagnose or provide clinical advice.");
