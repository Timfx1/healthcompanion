...
<head>
<meta charset="utf-8" />
<title>Healthcompanion report</title>
<style>
...
<div class="sheet">
  ...
  <header class="masthead">
    <div class="brand">
      ...
      <div>
        <div class="brand__name">Healthcompanion</div>
...
<footer class="footer">
  ...
  Healthcompanion is not a medical device and does not diagnose, treat, or provide clinical advice. Nothing in this
  report should be read as clearance to return to sport or activity.
  Generated by Healthcompanion on ${escapeHtml(formatDate(now.toISOString()))}.
</footer>
