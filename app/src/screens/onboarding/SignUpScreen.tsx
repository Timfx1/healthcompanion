  ...
  const continueWithGoogle = async () => {
    ...
    if (Constants.appOwnership === "expo") {
      Alert.alert(
        ...
        "Google sign-in cannot be tested reliably inside Expo Go because OAuth needs Recovery Health Companion's own app scheme. Email and Guest work in Expo Go. To test Google, run an EAS development build."
      );
      return;
    }
    ...
    if (!NativeModules.RNGoogleSignin) {
      Alert.alert(
        "Rebuild needed",
        "Google Sign-In was added as a native module. Rebuild and reinstall the Recovery Health Companion development app, then start Metro again."
      );
      return;
    }
  ...
  const continueWithApple = async () => {
    ...
    if (Constants.appOwnership === "expo") {
      Alert.alert(
        ...
        "Apple sign-in needs Recovery Health Companion's own app build and Firebase Apple provider setup. Email and Guest work in Expo Go."
      );
      return;
    }
