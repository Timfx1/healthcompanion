...
const SEEDS: Seed[] = [
  ...
  { day: 5, hour: 19, type: "capture", title: "managed the stairs once, very slowly", isAutoGenerated: false, data: { text: "managed the stairs once, very slowly", autoTags: ["energy"] } },
  ...
  { day: 11, hour: 18, type: "capture", title: "forgot the evening naproxen", isAutoGenerated: false, data: { text: "forgot the evening naproxen", autoTags: ["meds"] } },
  ...
  { day: 33, hour: 18, type: "capture", title: "stairs twice today and did not think about it", isAutoGenerated: false, data: { text: "stairs twice today and did not think about it", autoTags: ["energy"] } },
