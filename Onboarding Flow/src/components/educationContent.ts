// ============================================================
// Education content (§4.8, P9).
//
// ⚠ PLACEHOLDER, CITED, FLAGGED FOR REVIEW — same standard as safetyContent.ts
// and the corridor data. Every article names a source and links out to it; the
// app summarises, it does not become the authority.
//
